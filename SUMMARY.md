...
* [API Reference](reference/api-reference/README.md)
  * [openadapt (module)](reference/api-reference/openadapt-module/README.md)
    * [App](reference/api-reference/openadapt-module/app/README.md)
      * [util](reference/api-reference/openadapt-module/app/util.md)
      * [cards](reference/api-reference/openadapt-module/app/cards.md)
    ...
    * [playback.py](reference/api-reference/openadapt-module/playback.py.md)
    * [db.py](reference/api-reference/openadapt-module/db.py.md)
    * [crud.py](reference/api-reference/openadapt-module/crud.py.md)
    * [cache.py](reference/api-reference/openadapt-module/cache.py.md)
    * [common.py](reference/api-reference/openadapt-module/common.py.md)
    * [events.py](reference/api-reference/openadapt-module/events.py.md)
